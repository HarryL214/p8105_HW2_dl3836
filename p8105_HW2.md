...
I build a dataset which has **17284** monthly observations.  
These cover **149** ZIP codes and **43** neighborhoods in New York City.

When comparing zip map file with Zillow’s rental chart, I found **171**
ZIP codes present in the map but not in the Zillow.  
These missing ZIP codes are often special-purpose codes such as
airports, PO Boxes, and so on.
